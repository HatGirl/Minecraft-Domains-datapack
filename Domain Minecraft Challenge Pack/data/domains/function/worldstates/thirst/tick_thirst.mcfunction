execute as @a[tag=!sprinting,scores={thirst=..120}] at @s run scoreboard players add @s thirst_ticks 1
execute as @a[tag=sprinting,scores={thirst=..120}] at @s run scoreboard players add @s thirst_ticks 2

execute as @a[scores={thirst_ticks=120}] at @s run scoreboard players remove @s thirst 1
execute as @a[scores={thirst_ticks=120..}] at @s run scoreboard players set @s thirst_ticks 0
